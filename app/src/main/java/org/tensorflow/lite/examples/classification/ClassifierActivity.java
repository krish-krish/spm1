...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  protected void onInferenceConfigurationChanged() {
    LOGGER.d("onInferenceConfigurationChanged (E)");
    ...
    LOGGER.d("onInferenceConfigurationChanged (X)");
  }

  private void recreateClassifier(Model model, Device device, int numThreads, String mode) {
    if (classifier != null) {
    ...
    try {
      LOGGER.d(
          "Creating classifier (model=%s, device=%s, numThreads=%d, mode=%s)", model, device,
              numThreads, mode);
